...
import { ArrowRight, CheckCircle2, ShieldCheck, Truck, Globe } from 'lucide-react';
...
const VendorForm: React.FC<VendorFormProps> = ({ lang }) => {
  ...
  const t = {
    fr: {
      ...
      desc: "TrustLink connecte les vendeurs nigérians au marché béninois — sans réseau privé, sans barrière logistique. Vos fonds sont sécurisés via notre système de séquestre dès la commande passée.",
      benefit1_t: "Paiement Garanti via Séquestre",
      benefit1_d: "Dès qu'une commande est passée, les fonds de l'acheteur sont sécurisés dans notre système de séquestre. Votre paiement est protégé et garanti avant même que vous expédiez quoi que ce soit.",
      ...
      benefit3_d: "Le marché béninois est verrouillé derrière des réseaux privés. TrustLink vous y connecte directement — des acheteurs qui cherchent vos produits sans pouvoir vous trouver.",
      ...
      placeholder_cat: "Ex: Vêtements, électronique, pièces auto, cosmétiques...",
    ...
    en: {
      ...
      desc: "TrustLink connects Nigerian sellers to the Beninese market — no private network, no logistical barriers. Your funds are secured through our escrow system from the moment an order is placed.",
      benefit1_t: "Guaranteed Payment via Escrow",
      benefit1_d: "As soon as an order is placed, the buyer's funds are secured in our escrow system. Your payment is protected and guaranteed before you even ship anything.",
      ...
      benefit3_d: "The Beninese market is locked behind private networks. TrustLink connects you directly — buyers who are looking for your products but have no way to find you.",
      ...
      placeholder_cat: "e.g. Clothing, electronics, auto parts, cosmetics...",
