...
const Hero: React.FC<HeroProps> = ({ lang }) => {
  const t = {
    fr: {
      ...
      h1: "Vendez au Bénin. ",
      h1Span: "Payé en Naira.",
      p: "Le hub d'exportation qui connecte les grossistes nigérians au marché béninois. Éliminez le risque de change : nous collectons vos marchandises à Lagos et vous payons instantanément en Naira.",
    ...
    en: {
      ...
      h1: "Sell to Benin. ",
      h1Span: "Get Paid in Naira.",
      p: "The export hub connecting Nigerian wholesalers to the Beninese market. Eliminate currency risk: we pick up your goods in Lagos and pay you instantly in Naira.",
...
export default Hero;
import React from 'react';
import { Search, Wallet, Truck, CheckCircle2 } from 'lucide-react';
    ...
    <section id="how" className="py-24 bg-white">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 relative">
          ...
          <div className="hidden lg:block absolute top-1/4 left-0 right-0 h-0.5 bg-slate-100 -z-10"></div>
          
          {t.steps.map((step, i) => (
            <div key={i} className="flex flex-col items-center text-center group">
              <div className="w-20 h-20 bg-white border-4 border-slate-50 rounded-3xl shadow-xl flex items-center justify-center mb-8 group-hover:border-blue-500 transition-all duration-500 group-hover:-translate-y-2">
                {step.icon}
              </div>
              ...
              <div className="mt-6 w-8 h-8 rounded-full bg-slate-900 text-white text-xs font-black flex items-center justify-center">
                0{i + 1}
              </div>
            </div>
          ))}
